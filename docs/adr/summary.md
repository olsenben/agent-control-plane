...
| ADR-0043 | CT104 HTTPS clone helper is inspected and fail-closed against known write PATs | proposed | 2026-08-24 | Inspect git-credentials hashes against CT104_FORBIDDEN_GIT_TOKEN_SHA256; env-only PASS cannot hide a write PAT; live push probe remains AUTH FAILURE authority |
...
- 2026-08-24 — ADR-0043 proposed: CT104 clone helper fail-closed against known write PAT hashes; live push probe remains AUTH FAILURE authority
