...
| **Next** | **V4.1.2 / sessions** | Typed sessions (5.4) → preflight (5.5) → verification gate (5.6) → selective writeback (5.7). See [slice-v412-typed-sessions.md](slice-v412-typed-sessions.md) |
