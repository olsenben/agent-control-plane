...
| **V5 governance epic** | **complete** | T01–T06 Done tip `7b01adc` — [handoff/boss-ledger-v5.md](handoff/boss-ledger-v5.md) |
...
| **V5 T06 Gated self-improvement** | **2026-07-20** | tip `7b01adc`; Actions 742–744; PR #31 propose + in-prod deny — [slice-v5-t06-gated-self-improvement.md](slice-v5-t06-gated-self-improvement.md), ADR-0025 |
