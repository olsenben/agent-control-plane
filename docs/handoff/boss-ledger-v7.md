...
| **Tickets done (count)** | 0 / 5 |
| **Next ticket** | T01 |
| **Latest handoff** | — |
| **Coordinator waves completed** | 0 |
| **Last boss action** | 2026-07-21 — epic opened after QA V6 SIGNED OFF tip `28292c0` |
...
|----|-------|------|------------------------|--------|
| **T01** | **Inspect adapter** — `eval_bundle.v1` → Inspect AI tasks (framework-neutral import) | — | Import one exported bundle; Inspect task loads timeline/stages; no prod memory write | Todo |
| **T02** | **Profiles A–D** — controller / context strategy ablation configs | T01 | Four named profiles selectable; each runs against same fixture bundle | Todo |
| **T03** | **Metrics** — CT102 success, repair iters, fallback, policy violations, tokens/cost/time | T01 | Metrics JSON emitted per profile run; fields documented | Todo |
