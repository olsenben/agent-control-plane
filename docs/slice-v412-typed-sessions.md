...
**Status:** **V4.1.2 core exit verified** 2026-07-20 — 5.4–5.7 + review→plan memory loop ([slice-v412-exit.md](slice-v412-exit.md)); next epic **T04**  
**Date:** 2026-07-19  
...
**Status:** **Accepted** 2026-07-20 — homelab early/late deny on `dfb3d22`. See [slice-5.4b-session-failure-taxonomy.md](slice-5.4b-session-failure-taxonomy.md).
